...
echo "<h2>HealthMate Food Database Installation</h2>";

try {
    $pdo = getDBConnection();
    echo "<p style='color: green;'>✓ Database connection successful!</p>";
    
    // Read and execute the food database schema
    $sqlFile = __DIR__ . '/food_database.sql';
    
    if (!file_exists($sqlFile)) {
        throw new Exception("Food database SQL file not found: $sqlFile");
    }
    ...
    if ($errorCount === 0) {
        echo "<h3 style='color: green;'>🎉 Food Database Installation Complete!</h3>";
