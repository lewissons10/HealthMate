-- Add Food Database Tables to HealthMate Database
-- This file adds food-related tables to the existing healthmate_db database
...
-- Show summary
SELECT 'Food Database Installation Complete!' as status;
SELECT COUNT(*) as total_foods FROM foods;
SELECT COUNT(*) as total_vitamins FROM food_vitamins;
SELECT COUNT(*) as total_minerals FROM food_minerals;
SELECT DISTINCT category, COUNT(*) as count FROM foods GROUP BY category ORDER BY count DESC;
